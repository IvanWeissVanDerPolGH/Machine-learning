...
num_points = 500
group_names_color = [{"name": 'Group_1', "color": 'Red'}, {"name": 'Group_2', "color": 'Blue'}]

points_data_group1 = generate_scattered_points(num_points, center_x=0, center_y=0, min_dist=8, max_dist=15)
df_group1 = create_dataframe(points_data_group1, group_names_color[0])

points_data_group2 = generate_scattered_points(int(num_points/5), center_x=0, center_y=0, min_dist=0, max_dist=5)
...
# Train SVM models and plot decision boundaries
trained_models = train_svm_model_for_groups(df_points,"rbf")
# plot_groups_with_decision_boundary(df_points, trained_models)
